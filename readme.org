...
(use-package yomikun-db    :straight nil :load-path "~/.emacs.d/modules/yomikun")
(use-package yomikun-mecab  :straight nil :load-path "~/.emacs.d/modules/yomikun")
(use-package yomikun
  :straight nil
...
(use-package yomikun-dict :straight nil :load-path "~/.emacs.d/modules/yomikun")
#+end_src
